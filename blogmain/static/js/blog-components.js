...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function createProgressBar() {
        let progressDiv = document.querySelector('.reading-progress');
        if (!progressDiv) {
    ...
    function generateTableOfContents() {
        ...
        if (sidebar.querySelector('.table-of-contents')) return;
    ...
    function addCopyLinkButton() {
        ...
        if (shareButtons.querySelector('.copy-link')) return;
    ...
    function openLightbox(img, currentIndex, allImages) {
        ...
        let style = document.getElementById('lightbox-style');
        if (!style) {
    ...
    function showSelectionTooltip(selection, text) {
        ...
        let style = document.getElementById('selection-tooltip-style');
        if (!style) {
            style = document.createElement('style');
    ...
    function addKeyboardShortcuts() {
        if (document.querySelector('.keyboard-help-btn')) return;
    ...
    function showKeyboardHelp() {
        if (document.querySelector('.help-modal-wrapper')) return;
        
        const helpModal = document.createElement('div');
        helpModal.className = 'help-modal-wrapper';
        helpModal.innerHTML = `
        ...
        let style = document.getElementById('help-modal-style');
        if (!style) {
            style = document.createElement('style');
    ...
    function trackUserInteractions() {
        ...
        const trackingHandler = throttle(() => {
